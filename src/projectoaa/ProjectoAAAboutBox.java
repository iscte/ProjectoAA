...
public class ProjectoAAAboutBox extends javax.swing.JDialog {

    public ProjectoAAAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(projectoaa.ProjectoAAApp.class).getContext().getResourceMap(ProjectoAAAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(projectoaa.ProjectoAAApp.class).getContext().getActionMap(ProjectoAAAboutBox.class, this);
